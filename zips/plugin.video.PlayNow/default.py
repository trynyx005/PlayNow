...
nome_contador = "PlayNow"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR red]Seja Bem-Vindo(a) ao PLAYNOW[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
...
## MENU CONFIGURAÇÕES
menu_configuracoes = "[B][COLOR red]CONFIGURAÇÕES[/COLOR][/B]"
...
url_origem = 'https://raw.githubusercontent.com/trynyx005/menu-principal/main/menu-principal'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]PlayNow[/COLOR][/B]", [
    "[B][COLOR white]Facebook - [/COLOR] FACEBOOK [/B]",
    "[B][COLOR white]Twitter - [/COLOR] TWITTER [/B]",
    "[B][COLOR white]Instagram - [/COLOR] INSTAGRAM [/B]",
    "[B][COLOR white]Entrar - [/COLOR] ENTRAR NO ADD-ON [/B]"])    
